...
const proxy = {
  ...
  'POST /api/mws/competitive-products/monitoring-settings/list': Mock.mock({
    ...
    'data': {
      ...
      'myProductData': {
        'id': null,
        'monitoringSwitch': null,
        'monitoringNumber': null,
        'updateTime': '2021-02-05 20:45:42',
        'currentRanking': null,
        'lastRanking': null,
        'rise': null,
        'image': 'https://images-na.ssl-images-amazon.com/images/I/31xDy06hvNL.jpg',
        'title': 'CNC Router Bit, EnPoint 3.175 mm Shank 0.2 mm Tips 25 Degree Carbide Engraving Bit, Metal Sign Marking Carving Tool for Aluminum Woodworking MDF PVC Wood Acrylic Board Plastic',
        'titleLink': 'https://www.amazon.com/dp/B07MM24CSL',
        'asin': 'B07MM24CSL',
        'brandName': 'ENPOINT',
        'sellerName': '',
        'deliveryMethod': '',
        ...
        'rankingChange': null,
        'reviewAvgStar': 4.7,
        'reviewScoreChange': null,
        'reviewCount': 25,
        'reviewCountChange': null,
        'usedNewSellNum': 0,
        'variantNum': 1,
        'dateFirstListed': '2019-01-09',
        'acKeyword': '',
