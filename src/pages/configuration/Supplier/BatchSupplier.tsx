...
const BatchSupplier: React.FC = () => {
  ...
  const uploadFile = function() {
    ...
    const promise = new Promise((resolve, reject) => {
      dispatch({
        type: 'supplier/updateBatchSupplier',
        payload: {
          file: fileList[0],
        },
        reject,
    ...
    content={<div className={styles.batchRelevanceBox}>
      <div className={styles.content}>
        ...
        <div className={styles.rightLayout}>
          <a href="/api/mws/shipment/supplier/importTemplate">下载模板</a>
        </div>
      </div>
  ...
  >
    <Button className={styles.batchBtn} >批量导入</Button>
  </Popover>;
};

export default BatchSupplier;
